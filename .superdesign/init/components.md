...
- Description: Base UI button with shared variants and sizes.
- Props: Base UI button props plus `variant` and `size`.
...
- Description: Accessible Base UI text/file input.
...
- Description: Progress root, label, track, indicator, and value.
...
- Description: Two-size accessible setting toggle.
...
- Source: `lib/utils.ts`
- Description: Tailwind-aware class merge helper.
